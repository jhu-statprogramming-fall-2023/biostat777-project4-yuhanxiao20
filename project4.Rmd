...
<font size="2"> 
Note: Testing about embeding Youtube video.
</font>
...
This dashboard is built upon the *salary_potential.csv* dataset from TidyTuesday. It contains 935 observations and 7 variables. Each observation provides information about colleges across various US states. For a more detailed understanding of the variables, please refer to this [data dictionary](https://github.com/rfordatascience/tidytuesday/tree/master/data/2020/2020-03-10#salary_potentialcsv) from TidyTuesday.
